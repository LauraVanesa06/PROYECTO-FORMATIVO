...
abstract class AppLocalizations {
  ...
  /// No description provided for @homeHardware.
  ///
  /// In en, this message translates to:
  /// **'Home Hardware'**
  String get homeHardware;
  ...
  /// No description provided for @adhesives.
  ///
  /// In en, this message translates to:
  /// **'Adhesives & Sealants'**
  String get adhesives;
  ...
  /// No description provided for @sendRecovery.
  ///
  /// In en, this message translates to:
  /// **'Send Recovery Link'**
  String get sendRecovery;
