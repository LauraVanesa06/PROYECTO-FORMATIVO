class FixPaymentsColumns < ActiveRecord::Migration[8.0]
  def up
    ...
    add_column :payments, :currency, :string, null: true, default: "COP"
    change_column :payments, :status, :integer, null: true, default: 0
    add_column :payments, :wompi_id, :string, null: true
    ...
    change_column :payments, :token, :string, null: true
    add_column :payments, :account_info, :string, null: true
  end
