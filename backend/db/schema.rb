...
ActiveRecord::Schema[8.0].define(version: 2025_06_22_032851) do

ActiveRecord::Schema[8.0].define(version: 2025_06_25_205355) do
  ...
  add_foreign_key "products", "proveedores"
